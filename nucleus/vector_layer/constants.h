...
constexpr auto data_size = std::array<uint32_t, 3> { 128u, 256u, 512u }; // needs to be in ascending order
...
static constexpr auto style_buffer_offset_by_one_zoom = 1;
// static constexpr auto style_buffer_offset_by_one_zoom = style_buffer_size; // TRANSPOSED STYLE BUFFER LAYOUT
