...
// static constexpr auto style_buffer_offset_by_one_zoom = style_buffer_size;
static constexpr auto style_buffer_offset_by_one_zoom = 1; // TRANSPOSED STYLE BUFFER LAYOUT
