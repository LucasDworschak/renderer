...
TEST_CASE("nucleus/vector_style")
{
    ...
    SECTION("Style parsing basemap")
    {
        ...
        CHECK(feature_to_style["GEBAEUDE_F_AGG__0"] == 84);
        CHECK(feature_to_style["GEBAEUDE_F_AGG__1"] == 88);
        ...
        CHECK(feature_to_style["GIP_BAUWERK_L_BRÜCKE__0"] == 756);
        CHECK(feature_to_style["GIP_BAUWERK_L_BRÜCKE__1"] == 736);
        CHECK(feature_to_style["GIP_BAUWERK_L_BRÜCKE__3"] == 688);
        CHECK(feature_to_style["GIP_BAUWERK_L_TUNNEL_BRUNNENCLA__0"] == 160);
        CHECK(feature_to_style["GIP_L_GIP_144__0"] == 756);
        CHECK(feature_to_style["GIP_L_GIP_144__1"] == 736);
        CHECK(feature_to_style["GIP_L_GIP_144__3"] == 688);
        CHECK(feature_to_style["GIP_L_GIP_144__4"] == 644);
        CHECK(feature_to_style["GIP_L_GIP_144__5"] == 668);
        CHECK(feature_to_style["GIP_L_GIP_144__6"] == 664);
