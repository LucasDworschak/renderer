...
TEST_CASE("glsl tile functions")
{
    ...
    SECTION("vectorlayer packing c++ same as glsl")
    {
        const auto data = std::vector<std::tuple<glm::ivec2, glm::ivec2, glm::ivec2, uint32_t>> {
            { glm::ivec2(2568, -731), glm::ivec2(-428, 3500), glm::ivec2(4535, 298), 4040 },
            { glm::ivec2(4116, 2789), glm::ivec2(3248, 2225), glm::ivec2(1464, 4824), 4021 },
            { glm::ivec2(-344, 2433), glm::ivec2(71, 3082), glm::ivec2(2572, 1766), 810 },
            { glm::ivec2(2707, 2513), glm::ivec2(1179, 4218), glm::ivec2(1744, 3508), 4007 },
            { glm::ivec2(3697, 1196), glm::ivec2(1888, 3972), glm::ivec2(4821, 247), 3881 },
            { glm::ivec2(811, -881), glm::ivec2(2687, 2825), glm::ivec2(854, 2548), 562 },
            { glm::ivec2(3388, 1904), glm::ivec2(2635, 767), glm::ivec2(4655, 719), 3140 },
            { glm::ivec2(-293, 4040), glm::ivec2(4769, 3429), glm::ivec2(1977, 3670), 4025 },
            ...
            { glm::ivec2(2198, 10), glm::ivec2(107, 226), glm::ivec2(2811, 2905), 4030 },
            ...
            { glm::ivec2(-14, -852), glm::ivec2(159, 1886), glm::ivec2(-777, 2938), 3073 },
            ...
            { glm::ivec2(3177, 1344), glm::ivec2(3243, 3118), glm::ivec2(2261, 2246), 3770 },
