...
TerrainRenderer::TerrainRenderer()
{
    ...
    connect(m_camera_controller.get(), &CameraController::definition_changed, ctx->vector_layer_scheduler(),  &Scheduler::update_camera);
    ...
    connect(ctx->vector_layer_scheduler(),  &nucleus::vector_layer::Scheduler::gpu_tiles_updated, gl_window_ptr, &gl_engine::Window::update_requested);
