...
GlParams gl_tex_params(gl_engine::Texture::Format format)
{
    ...
    case F::RGBA32I:
        return { GL_RGBA32I, GL_RGBA_INTEGER, GL_INT, 4, 4 };
    case F::RGBA32UI:
...
template void gl_engine::Texture::upload<glm::vec<2, uint16_t>>(const nucleus::Raster<glm::vec<2, uint16_t>>&, unsigned);
...
template void gl_engine::Texture::upload<glm::vec<4, uint32_t>>(const nucleus::Raster<glm::vec<4, uint32_t>>&, unsigned);
...
template void gl_engine::Texture::upload<glm::vec<4, int32_t>>(const nucleus::Raster<glm::vec<4, int32_t>>&, unsigned);
...
template void gl_engine::Texture::upload<glm::vec<4, int32_t>>(const nucleus::Raster<glm::vec<4, int32_t>>&);
